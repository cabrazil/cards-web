export function Header() {
  ...
  return (
    <header className="mb-4">
      ...
      Bem-vindos! Será que existe um cartão perfeito para todos? <span className="text-[#4169e1] italic">Spoiler: não!</span> Sua renda, hábitos e sonhos, sua realidade define o que é ideal para você. 
      Por outro lado, se olharmos para: <span className="text-[#4169e1] italic">grupos de pessoas com realidades semelhantes</span> podemos encontrar ótimas opções. Quer saber como e achar o cartão que combina com sua vida? Aqui, revelamos dicas e
